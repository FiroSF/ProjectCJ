...
public class GluePoint {
    ...
    public static final int RETURN_BLOCK = NORMAL_BLOCK | 4;
    ...
    public static final int NORMAL_LOWER_CHECK = NORMAL_BLOCK | SCOPE_BLOCK | RETURN_BLOCK | 1024;
    public static final int SCOPE_INNER_CHECK = NORMAL_BLOCK | SCOPE_BLOCK | RETURN_BLOCK | 2048;
    public static final int PARAMETER_CHECK = RETURN_BLOCK | 4096;
